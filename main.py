...
pygame.display.set_caption("Ennemies Defender".upper())
...
playerX ,playerY = 295,540 #H in the middle of the screen, V down of the screen 
playerchange,playerchangeY = 0,0 #move horiz (R/L),move vertical (Up/down)

# enemies
enemyimg, enemyX, enemyY, enemychange = [], [],[],[] 
 
num = 4 
enemyimg = [pygame.image.load("virus.png"), pygame.image.load("virus1.png"), pygame.image.load("virus2.png"), pygame.image.load("virus3.png")]
for i in range(num):
...
bulletX = 310 #depart position x (middle of the ship)
bulletY = 540 #depart position y (same height of the ship)
bulletchangeX = 0 #step of mvmnt H
bulletchangeY = -2 #up to 2px in evry img
bulletstate = "ready" #ready means =  not yet launched, "fire" = flying

#stones
stoneimg, stoneX, stoneY, stonespeed = [],[],[],[]
stonenum = 5
if scorevalue >= 200:
    stonenum = 10 #If the score is high, more stones are added
...
for u in range(stonenum):
    ...
    stonespeed.append(1.2) #constant speed
...
def tips():
    tiptxt = tip.render("Tip:Power Activated.", True, (255, 255, 0))
